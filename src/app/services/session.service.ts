...
export class SessionService {
  ...
  /**
    * Guarda los valores de la sesión actual en el almacenamiento local.
   * @param refresh si lo observable debe ser empujado o no
   */
  ...
  //  Actualiza la sesión actual con datos del estado del tablero y empuja lo observable
